...
VALUES
    (1, '김프론트', '프론트마스터', 'front1@test.com', 'https://test.com/image1.jpg', 'USER', 'WOMEN', 'SEOUL', 'FRONTEND', 'ENFP', 'COMPLETED', '안녕하세요! 프론트엔드 개발자입니다.', true, 1, 'MBTI_FOCUSED', NOW(), NOW()),
    ...
    (3, '박뷰js', '뷰제이에스', 'front3@test.com', 'https://test.com/image3.jpg', 'USER', 'WOMEN', 'SKKU', 'FRONTEND', 'ENTP', 'COMPLETED', 'Vue.js로 멋진 웹을 만들어요', true, 1, 'MBTI_FOCUSED', NOW(), NOW()),
    ...
    (5, '정디자인', '창의디자이너', 'ux2@test.com', 'https://test.com/image5.jpg', 'USER', 'MEN', 'HONGIK', 'UX_UI', 'ENTP', 'COMPLETED', '창의적인 디자인으로 세상을 바꿔요', true, 1, 'MBTI_FOCUSED', NOW(), NOW()),
...
-- === 클러스터 2: 내향적 + 백엔드 계열 (5명) ===
    ...
    (7, '이스프링', '스프링마스터', 'back2@test.com', 'https://test.com/image7.jpg', 'USER', 'MEN', 'YONSEI_SINCHON', 'BACKEND', 'INTJ', 'COMPLETED', 'Spring Framework 마스터', false, 2, 'MBTI_FOCUSED', NOW(), NOW()),
    ...
    (9, '최노드', '노드제이에스', 'back4@test.com', 'https://test.com/image9.jpg', 'USER', 'MEN', 'YONSEI_SINCHON', 'BACKEND', 'INTP', 'COMPLETED', 'Node.js 백엔드 개발자', false, 2, 'MBTI_FOCUSED', NOW(), NOW()),
...
-- === 클러스터 3: 혼합형 - 다양한 조합 (10명) ===
    (11, '김풀스택', '풀스택개발자', 'full1@test.com', 'https://test.com/image11.jpg', 'USER', 'MEN', 'CAU', 'FULLSTACK', 'ENTJ', 'COMPLETED', '풀스택 개발자로 전체를 아우르는 개발을 해요', true, 3, 'MBTI_FOCUSED', NOW(), NOW()),
    ...
    (13, '박기획', 'PM리더', 'pm2@test.com', 'https://test.com/image13.jpg', 'USER', 'MEN', 'HANYANG_ERICA', 'PM', 'ENFJ', 'COMPLETED', '사람과 기술을 연결하는 PM', false, 3, 'MBTI_FOCUSED', NOW(), NOW()),
    ...
    (15, '정크리에이터', '감성디자이너', 'ux3@test.com', 'https://test.com/image15.jpg', 'USER', 'WOMEN', 'SUNGSHIN', 'UX_UI', 'ISFP', 'COMPLETED', '감성적인 디자인을 추구해요', true, 3, 'MBTI_FOCUSED', NOW(), NOW()),
    ...
    (17, '이웹개발', '즐거운개발자', 'web1@test.com', 'https://test.com/image17.jpg', 'USER', 'WOMEN', 'DONGDUK', 'FRONTEND', 'ESFP', 'COMPLETED', '즐겁게 웹 개발하는 개발자', true, 3, 'MBTI_FOCUSED', NOW(), NOW()),
    ...
    (19, '최리더', '액션리더', 'leader1@test.com', 'https://test.com/image19.jpg', 'USER', 'WOMEN', 'EWHA', 'PM', 'ESTP', 'COMPLETED', '액션형 프로젝트 리더', false, 3, 'MBTI_FOCUSED', NOW(), NOW()),
    (20, '정올인원', '효율개발자', 'all1@test.com', 'https://test.com/image20.jpg', 'USER', 'MEN', 'SEOUL', 'FULLSTACK', 'ISTP', 'COMPLETED', '실용적이고 효율적인 개발을 추구합니다', true, 3, 'POSITION_FOCUSED', NOW(), NOW());
