...
public interface FeedRepository extends JpaRepository<Feed, Long> {
    ...
    @Query("""
            ...
            order by f.id desc""")
    List<Feed> fetchRecentFeedsFirst(Pageable pageable);
    ...
    order by f.id desc
    """)
    List<Feed> fetchRecentFeedsAfter(Long lastId, Pageable pageable);
    ...
    List<Feed> fetchHotFeedsFirst(Pageable pageable);
